...
@Embeddable
@Getter
public class VotingOptionResultId implements Serializable {
    ...
    protected VotingOptionResultId() {
    }

    public VotingOptionResultId(UUID votingProposalId, Long votingOptionNumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VotingOptionResultId that)) {
            return false;
        }
